//! Shared types for Bitcoin RPC API code generation.
//!
//! This crate contains the core types used across the entire codebase:
//! - `ApiMethod`, `ApiArgument`, `ApiResult` - Core API schema types
//! - `Version` - Bitcoin Core version handling
//! - `parse_api_json` - JSON parsing functionality
//!
//! This eliminates circular dependencies by providing a shared foundation
//! that all other crates can depend on.
