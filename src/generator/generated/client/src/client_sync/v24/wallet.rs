/// Implements Bitcoin Core JSON-RPC API method `abandontransaction` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__abandontransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `abortrescan` for version v24
///
/// Stops current wallet rescan triggered by an RPC call, e.g. by an importprivkey call.
/// Note: Use "getwalletinfo" to query the scanning progress.
#[macro_export]
macro_rules! impl_client_v24__abortrescan {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `addmultisigaddress` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__addmultisigaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `backupwallet` for version v24
///
/// Safely copies the current wallet file to the specified destination, which can either be a directory or a path with a filename.
#[macro_export]
macro_rules! impl_client_v24__backupwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `bumpfee` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__bumpfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createwallet` for version v24
///
/// Creates and loads a new wallet.
#[macro_export]
macro_rules! impl_client_v24__createwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createwalletdescriptor` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__createwalletdescriptor {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `dumpprivkey` for version v24
///
/// Reveals the private key corresponding to 'address'.
/// Then the importprivkey can be used with this output
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v24__dumpprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `dumpwallet` for version v24
///
...
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v24__dumpwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `encryptwallet` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__encryptwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getaddressesbylabel` for version v24
///
/// Returns the list of addresses assigned the specified label.
#[macro_export]
macro_rules! impl_client_v24__getaddressesbylabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getaddressinfo` for version v24
///
/// Return information about the given bitcoin address.
/// Some of the information will only be present if the address is in the active wallet.
#[macro_export]
macro_rules! impl_client_v24__getaddressinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getbalance` for version v24
///
/// Returns the total available balance.
/// The available balance is what the wallet considers currently spendable, and is
/// thus affected by options which limit spendability such as -spendzeroconfchange.
#[macro_export]
macro_rules! impl_client_v24__getbalance {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getbalances` for version v24
///
/// Returns an object with all balances in BTC.
#[macro_export]
macro_rules! impl_client_v24__getbalances {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gethdkeys` for version v24
///
/// List all BIP 32 HD keys in the wallet and which descriptors use them.
#[macro_export]
macro_rules! impl_client_v24__gethdkeys {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getnewaddress` for version v24
///
/// Returns a new Bitcoin address for receiving payments.
/// If 'label' is specified, it is added to the address book
/// so payments received with the address will be associated with 'label'.
#[macro_export]
macro_rules! impl_client_v24__getnewaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawchangeaddress` for version v24
///
/// Returns a new Bitcoin address, for receiving change.
/// This is for use with raw transactions, NOT normal use.
#[macro_export]
macro_rules! impl_client_v24__getrawchangeaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getreceivedbyaddress` for version v24
///
/// Returns the total amount received by the given address in transactions with at least minconf confirmations.
#[macro_export]
macro_rules! impl_client_v24__getreceivedbyaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getreceivedbylabel` for version v24
///
/// Returns the total amount received by addresses with <label> in transactions with at least [minconf] confirmations.
#[macro_export]
macro_rules! impl_client_v24__getreceivedbylabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gettransaction` for version v24
///
/// Get detailed information about in-wallet transaction <txid>
#[macro_export]
macro_rules! impl_client_v24__gettransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getunconfirmedbalance` for version v24
///
/// DEPRECATED
/// Identical to getbalances().mine.untrusted_pending
#[macro_export]
macro_rules! impl_client_v24__getunconfirmedbalance {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getwalletinfo` for version v24
///
/// Returns an object containing various wallet state info.
#[macro_export]
macro_rules! impl_client_v24__getwalletinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importaddress` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__importaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importdescriptors` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__importdescriptors {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importmulti` for version v24
///
...
/// Note: This command is only compatible with legacy wallets. Use "importdescriptors" for descriptor wallets.
#[macro_export]
macro_rules! impl_client_v24__importmulti {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importprivkey` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__importprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importprunedfunds` for version v24
///
/// Imports funds without rescan. Corresponding address or script must previously be included in wallet. Aimed towards pruned wallets. The end-user is responsible to import additional transactions that subsequently spend the imported outputs or rescan after the point in the blockchain the transaction is included.
#[macro_export]
macro_rules! impl_client_v24__importprunedfunds {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importpubkey` for version v24
///
...
/// Note: This command is only compatible with legacy wallets. Use "importdescriptors" with "combo(X)" for descriptor wallets.
#[macro_export]
macro_rules! impl_client_v24__importpubkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importwallet` for version v24
///
/// Imports keys from a wallet dump file (see dumpwallet). Requires a new wallet backup to include imported keys.
/// Note: Blockchain and Mempool will be rescanned after a successful import. Use "getwalletinfo" to query the scanning progress.
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v24__importwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `keypoolrefill` for version v24
///
/// Fills the keypool.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__keypoolrefill {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listaddressgroupings` for version v24
///
/// Lists groups of addresses which have had their common ownership
/// made public by common use as inputs or as the resulting change
/// in past transactions
#[macro_export]
macro_rules! impl_client_v24__listaddressgroupings {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listdescriptors` for version v24
///
/// List descriptors imported into a descriptor-enabled wallet.
#[macro_export]
macro_rules! impl_client_v24__listdescriptors {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listlabels` for version v24
///
/// Returns the list of all labels, or labels that are assigned to addresses with a specific purpose.
#[macro_export]
macro_rules! impl_client_v24__listlabels {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listlockunspent` for version v24
///
/// Returns list of temporarily unspendable outputs.
/// See the lockunspent call to lock and unlock transactions for spending.
#[macro_export]
macro_rules! impl_client_v24__listlockunspent {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listreceivedbyaddress` for version v24
///
/// List balances by receiving address.
#[macro_export]
macro_rules! impl_client_v24__listreceivedbyaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listreceivedbylabel` for version v24
///
/// List received transactions by label.
#[macro_export]
macro_rules! impl_client_v24__listreceivedbylabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listsinceblock` for version v24
///
...
/// Implements Bitcoin Core JSON-RPC API method `listtransactions` for version v24
///
/// If a label name is provided, this will return only incoming transactions paying to addresses with the specified label.
/// Returns up to 'count' most recent transactions skipping the first 'from' transactions.
#[macro_export]
macro_rules! impl_client_v24__listtransactions {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listunspent` for version v24
///
/// Returns array of unspent transaction outputs
/// with between minconf and maxconf (inclusive) confirmations.
/// Optionally filter to only include txouts paid to specified addresses.
#[macro_export]
macro_rules! impl_client_v24__listunspent {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listwalletdir` for version v24
///
/// Returns a list of wallets in the wallet directory.
#[macro_export]
macro_rules! impl_client_v24__listwalletdir {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listwallets` for version v24
///
/// Returns a list of currently loaded wallets.
/// For full information on the wallet, use "getwalletinfo"
#[macro_export]
macro_rules! impl_client_v24__listwallets {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `loadwallet` for version v24
///
/// Loads a wallet from a wallet file or directory.
/// Note that all wallet command-line options used when starting bitcoind will be
/// applied to the new wallet.
#[macro_export]
macro_rules! impl_client_v24__loadwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `lockunspent` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__lockunspent {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `migratewallet` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__migratewallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `newkeypool` for version v24
///
...
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__newkeypool {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `psbtbumpfee` for version v24
///
/// Bumps the fee of an opt-in-RBF transaction T, replacing it with a new transaction B.
...
/// * WARNING: before version 0.21, fee_rate was in BTC/kvB. As of 0.21, fee_rate is in sat/vB. *
#[macro_export]
macro_rules! impl_client_v24__psbtbumpfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `removeprunedfunds` for version v24
///
/// Deletes the specified transaction from the wallet. Meant for use with pruned wallets and as a companion to importprunedfunds. This will affect wallet balances.
#[macro_export]
macro_rules! impl_client_v24__removeprunedfunds {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `rescanblockchain` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__rescanblockchain {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `restorewallet` for version v24
///
/// Restores and loads a wallet from backup.
/// The rescan is significantly faster if a descriptor wallet is restored
/// and block filters are available (using startup option "-blockfilterindex=1").
#[macro_export]
macro_rules! impl_client_v24__restorewallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `send` for version v24
///
/// EXPERIMENTAL warning: this call may be changed in future releases.
/// Send a transaction.
#[macro_export]
macro_rules! impl_client_v24__send {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendall` for version v24
///
/// EXPERIMENTAL warning: this call may be changed in future releases.
...
#[macro_export]
macro_rules! impl_client_v24__sendall {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendmany` for version v24
///
/// Send multiple times. Amounts are double-precision floating point numbers.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__sendmany {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendtoaddress` for version v24
///
/// Send an amount to a given address.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__sendtoaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sethdseed` for version v24
///
...
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v24__sethdseed {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setlabel` for version v24
///
/// Sets the label associated with the given address.
#[macro_export]
macro_rules! impl_client_v24__setlabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `settxfee` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__settxfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setwalletflag` for version v24
///
/// Change the state of the given wallet flag for a wallet.
#[macro_export]
macro_rules! impl_client_v24__setwalletflag {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signmessage` for version v24
///
/// Sign a message with the private key of an address
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__signmessage {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signrawtransactionwithwallet` for version v24
///
...
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__signrawtransactionwithwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `simulaterawtransaction` for version v24
///
/// Calculate the balance change resulting in the signing and broadcasting of the given transaction(s).
#[macro_export]
macro_rules! impl_client_v24__simulaterawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `unloadwallet` for version v24
///
/// Unloads the wallet referenced by the request endpoint, otherwise unloads the wallet specified in the argument.
/// Specifying the wallet name on a wallet endpoint is invalid.
#[macro_export]
macro_rules! impl_client_v24__unloadwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `upgradewallet` for version v24
///
/// Upgrade the wallet. Upgrades to the latest version if no version number is specified.
/// New keys may be generated and a new wallet backup will need to be made.
#[macro_export]
macro_rules! impl_client_v24__upgradewallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletcreatefundedpsbt` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__walletcreatefundedpsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletdisplayaddress` for version v24
///
/// Display address on an external signer for verification.
#[macro_export]
macro_rules! impl_client_v24__walletdisplayaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletlock` for version v24
///
/// Removes the wallet encryption key from memory, locking the wallet.
/// After calling this method, you will need to call walletpassphrase again
/// before being able to call any methods which require the wallet to be unlocked.
#[macro_export]
macro_rules! impl_client_v24__walletlock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletpassphrase` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__walletpassphrase {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletpassphrasechange` for version v24
///
/// Changes the wallet passphrase from 'oldpassphrase' to 'newpassphrase'.
#[macro_export]
macro_rules! impl_client_v24__walletpassphrasechange {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletprocesspsbt` for version v24
///
/// Update a PSBT with input information from our wallet and then sign inputs
/// that we can sign for.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v24__walletprocesspsbt {
    () => {
        impl Client {
