/// Implements Bitcoin Core JSON-RPC API method `dumptxoutset` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__dumptxoutset {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getbestblockhash` for version v20
///
/// Returns the hash of the best (tip) block in the most-work fully-validated chain.
#[macro_export]
macro_rules! impl_client_v20__getbestblockhash {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblock` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__getblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockchaininfo` for version v20
///
/// Returns an object containing various state info regarding blockchain processing.
#[macro_export]
macro_rules! impl_client_v20__getblockchaininfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockcount` for version v20
///
/// Returns the height of the most-work fully-validated chain.
/// The genesis block has height 0.
#[macro_export]
macro_rules! impl_client_v20__getblockcount {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockfilter` for version v20
///
/// Retrieve a BIP 157 content filter for a particular block.
#[macro_export]
macro_rules! impl_client_v20__getblockfilter {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockfrompeer` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__getblockfrompeer {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockhash` for version v20
///
/// Returns hash of block in best-block-chain at height provided.
#[macro_export]
macro_rules! impl_client_v20__getblockhash {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockheader` for version v20
///
/// If verbose is false, returns a string that is serialized, hex-encoded data for blockheader 'hash'.
/// If verbose is true, returns an Object with information about blockheader <hash>.
#[macro_export]
macro_rules! impl_client_v20__getblockheader {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getblockstats` for version v20
///
/// Compute per block statistics for a given window. All amounts are in satoshis.
/// It won't work for some heights with pruning.
#[macro_export]
macro_rules! impl_client_v20__getblockstats {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getchainstates` for version v20
///
/// Return information about chainstates.
#[macro_export]
macro_rules! impl_client_v20__getchainstates {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getchaintips` for version v20
///
/// Return information about all known tips in the block tree, including the main chain as well as orphaned branches.
#[macro_export]
macro_rules! impl_client_v20__getchaintips {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getchaintxstats` for version v20
///
/// Compute statistics about the total number and rate of transactions in the chain.
#[macro_export]
macro_rules! impl_client_v20__getchaintxstats {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getdeploymentinfo` for version v20
///
/// Returns an object containing various state info regarding deployments of consensus changes.
#[macro_export]
macro_rules! impl_client_v20__getdeploymentinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getdifficulty` for version v20
///
/// Returns the proof-of-work difficulty as a multiple of the minimum difficulty.
#[macro_export]
macro_rules! impl_client_v20__getdifficulty {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmempoolancestors` for version v20
///
/// If txid is in the mempool, returns all in-mempool ancestors.
#[macro_export]
macro_rules! impl_client_v20__getmempoolancestors {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmempooldescendants` for version v20
///
/// If txid is in the mempool, returns all in-mempool descendants.
#[macro_export]
macro_rules! impl_client_v20__getmempooldescendants {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmempoolentry` for version v20
///
/// Returns mempool data for given transaction
#[macro_export]
macro_rules! impl_client_v20__getmempoolentry {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmempoolinfo` for version v20
///
/// Returns details on the active state of the TX memory pool.
#[macro_export]
macro_rules! impl_client_v20__getmempoolinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawmempool` for version v20
///
/// Returns all transaction ids in memory pool as a json array of string transaction ids.
/// Hint: use getmempoolentry to fetch a specific transaction from the mempool.
#[macro_export]
macro_rules! impl_client_v20__getrawmempool {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gettxout` for version v20
///
/// Returns details about an unspent transaction output.
#[macro_export]
macro_rules! impl_client_v20__gettxout {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gettxoutproof` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__gettxoutproof {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gettxoutsetinfo` for version v20
///
/// Returns statistics about the unspent transaction output set.
/// Note this call may take some time if you are not using coinstatsindex.
#[macro_export]
macro_rules! impl_client_v20__gettxoutsetinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gettxspendingprevout` for version v20
///
/// Scans the mempool to find transactions spending any of the given outputs
#[macro_export]
macro_rules! impl_client_v20__gettxspendingprevout {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importmempool` for version v20
///
/// Import a mempool.dat file and attempt to add its contents to the mempool.
/// Warning: Importing untrusted files is dangerous, especially if metadata from the file is taken over.
#[macro_export]
macro_rules! impl_client_v20__importmempool {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `loadtxoutset` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__loadtxoutset {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `preciousblock` for version v20
///
/// Treats a block as if it were received before others with the same work.
/// A later preciousblock call can override the effect of an earlier one.
/// The effects of preciousblock are not retained across restarts.
#[macro_export]
macro_rules! impl_client_v20__preciousblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `pruneblockchain` for version v20
///
/// 
#[macro_export]
macro_rules! impl_client_v20__pruneblockchain {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `savemempool` for version v20
///
/// Dumps the mempool to disk. It will fail until the previous dump is fully loaded.
#[macro_export]
macro_rules! impl_client_v20__savemempool {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `scanblocks` for version v20
///
/// Return relevant blockhashes for given descriptors (requires blockfilterindex).
/// This call may take several minutes. Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
#[macro_export]
macro_rules! impl_client_v20__scanblocks {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `scantxoutset` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__scantxoutset {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `verifychain` for version v20
///
/// Verifies blockchain database.
#[macro_export]
macro_rules! impl_client_v20__verifychain {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `verifytxoutproof` for version v20
///
/// Verifies that a proof points to a transaction in a block, returning the transaction it commits to
/// and throwing an RPC error if the block is not in our best chain
#[macro_export]
macro_rules! impl_client_v20__verifytxoutproof {
    () => {
        impl Client {
