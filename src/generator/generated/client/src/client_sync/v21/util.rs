/// Implements Bitcoin Core JSON-RPC API method `createmultisig` for version v21
///
/// Creates a multi-signature address with n signature of m keys required.
/// It returns a json object with the address and redeemScript.
#[macro_export]
macro_rules! impl_client_v21__createmultisig {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `deriveaddresses` for version v21
///
...
#[macro_export]
macro_rules! impl_client_v21__deriveaddresses {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `estimatesmartfee` for version v21
///
...
#[macro_export]
macro_rules! impl_client_v21__estimatesmartfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getdescriptorinfo` for version v21
///
/// Analyses a descriptor.
#[macro_export]
macro_rules! impl_client_v21__getdescriptorinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getindexinfo` for version v21
///
/// Returns the status of one or all available indices currently running in the node.
#[macro_export]
macro_rules! impl_client_v21__getindexinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signmessagewithprivkey` for version v21
///
/// Sign a message with the private key of an address
#[macro_export]
macro_rules! impl_client_v21__signmessagewithprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `validateaddress` for version v21
///
/// Return information about the given bitcoin address.
#[macro_export]
macro_rules! impl_client_v21__validateaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `verifymessage` for version v21
///
/// Verify a signed message.
#[macro_export]
macro_rules! impl_client_v21__verifymessage {
    () => {
        impl Client {
