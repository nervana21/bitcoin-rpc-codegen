/// Implements Bitcoin Core JSON-RPC API method `api` for version v21
///
/// Return JSON description of RPC API.
#[macro_export]
macro_rules! impl_client_v21__api {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmemoryinfo` for version v21
///
/// Returns an object containing information about memory usage.
#[macro_export]
macro_rules! impl_client_v21__getmemoryinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrpcinfo` for version v21
///
/// Returns details of the RPC server.
#[macro_export]
macro_rules! impl_client_v21__getrpcinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `help` for version v21
///
/// List all commands, or get help for a specified command.
#[macro_export]
macro_rules! impl_client_v21__help {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `logging` for version v21
///
...
#[macro_export]
macro_rules! impl_client_v21__logging {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `stop` for version v21
///
/// Request a graceful shutdown of Bitcoin Core.
#[macro_export]
macro_rules! impl_client_v21__stop {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `uptime` for version v21
///
/// Returns the total uptime of the server.
#[macro_export]
macro_rules! impl_client_v21__uptime {
    () => {
        impl Client {
