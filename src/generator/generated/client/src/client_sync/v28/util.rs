/// Implements Bitcoin Core JSON-RPC API method `createmultisig` for version v28
///
/// Creates a multi-signature address with n signature of m keys required.
/// It returns a json object with the address and redeemScript.
#[macro_export]
macro_rules! impl_client_v28__createmultisig {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `deriveaddresses` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__deriveaddresses {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `estimatesmartfee` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__estimatesmartfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getdescriptorinfo` for version v28
///
/// Analyses a descriptor.
#[macro_export]
macro_rules! impl_client_v28__getdescriptorinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getindexinfo` for version v28
///
/// Returns the status of one or all available indices currently running in the node.
#[macro_export]
macro_rules! impl_client_v28__getindexinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signmessagewithprivkey` for version v28
///
/// Sign a message with the private key of an address
#[macro_export]
macro_rules! impl_client_v28__signmessagewithprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `validateaddress` for version v28
///
/// Return information about the given bitcoin address.
#[macro_export]
macro_rules! impl_client_v28__validateaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `verifymessage` for version v28
///
/// Verify a signed message.
#[macro_export]
macro_rules! impl_client_v28__verifymessage {
    () => {
        impl Client {
