/// Implements Bitcoin Core JSON-RPC API method `analyzepsbt` for version v28
///
/// Analyzes and provides information about the current status of a PSBT and its inputs
#[macro_export]
macro_rules! impl_client_v28__analyzepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `combinepsbt` for version v28
///
/// Combine multiple partially signed Bitcoin transactions into one transaction.
/// Implements the Combiner role.
#[macro_export]
macro_rules! impl_client_v28__combinepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `combinerawtransaction` for version v28
///
/// Combine multiple partially signed transactions into one transaction.
/// The combined transaction may be another partially signed transaction or a
/// fully signed transaction.
#[macro_export]
macro_rules! impl_client_v28__combinerawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `converttopsbt` for version v28
///
/// Converts a network serialized transaction to a PSBT. This should be used only with createrawtransaction and fundrawtransaction
/// createpsbt and walletcreatefundedpsbt should be used for new applications.
#[macro_export]
macro_rules! impl_client_v28__converttopsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createpsbt` for version v28
///
/// Creates a transaction in the Partially Signed Transaction format.
/// Implements the Creator role.
#[macro_export]
macro_rules! impl_client_v28__createpsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createrawtransaction` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__createrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decodepsbt` for version v28
///
/// Return a JSON object representing the serialized, base64-encoded partially signed Bitcoin transaction.
#[macro_export]
macro_rules! impl_client_v28__decodepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decoderawtransaction` for version v28
///
/// Return a JSON object representing the serialized, hex-encoded transaction.
#[macro_export]
macro_rules! impl_client_v28__decoderawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decodescript` for version v28
///
/// Decode a hex-encoded script.
#[macro_export]
macro_rules! impl_client_v28__decodescript {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `descriptorprocesspsbt` for version v28
///
/// Update all segwit inputs in a PSBT with information from output descriptors, the UTXO set or the mempool.
/// Then, sign the inputs we are able to with information from the output descriptors.
#[macro_export]
macro_rules! impl_client_v28__descriptorprocesspsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `finalizepsbt` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__finalizepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `fundrawtransaction` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__fundrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawtransaction` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__getrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `joinpsbts` for version v28
///
/// Joins multiple distinct PSBTs with different inputs and outputs into one PSBT with inputs and outputs from all of the PSBTs
/// No input in any of the PSBTs can be in more than one of the PSBTs.
#[macro_export]
macro_rules! impl_client_v28__joinpsbts {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendrawtransaction` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__sendrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signrawtransactionwithkey` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__signrawtransactionwithkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `submitpackage` for version v28
///
...
/// Implements Bitcoin Core JSON-RPC API method `testmempoolaccept` for version v28
///
...
#[macro_export]
macro_rules! impl_client_v28__testmempoolaccept {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `utxoupdatepsbt` for version v28
///
/// Updates all segwit inputs and outputs in a PSBT with data from output descriptors, the UTXO set, txindex, or the mempool.
#[macro_export]
macro_rules! impl_client_v28__utxoupdatepsbt {
    () => {
        impl Client {
