/// Implements Bitcoin Core JSON-RPC API method `createmultisig` for version v26
///
/// Creates a multi-signature address with n signature of m keys required.
/// It returns a json object with the address and redeemScript.
#[macro_export]
macro_rules! impl_client_v26__createmultisig {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `deriveaddresses` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__deriveaddresses {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `estimatesmartfee` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__estimatesmartfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getdescriptorinfo` for version v26
///
/// Analyses a descriptor.
#[macro_export]
macro_rules! impl_client_v26__getdescriptorinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getindexinfo` for version v26
///
/// Returns the status of one or all available indices currently running in the node.
#[macro_export]
macro_rules! impl_client_v26__getindexinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signmessagewithprivkey` for version v26
///
/// Sign a message with the private key of an address
#[macro_export]
macro_rules! impl_client_v26__signmessagewithprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `validateaddress` for version v26
///
/// Return information about the given bitcoin address.
#[macro_export]
macro_rules! impl_client_v26__validateaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `verifymessage` for version v26
///
/// Verify a signed message.
#[macro_export]
macro_rules! impl_client_v26__verifymessage {
    () => {
        impl Client {
