/// Implements Bitcoin Core JSON-RPC API method `addnode` for version v26
///
...
/// Implements Bitcoin Core JSON-RPC API method `clearbanned` for version v26
///
/// Clear all banned IPs.
#[macro_export]
macro_rules! impl_client_v26__clearbanned {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `disconnectnode` for version v26
///
/// Immediately disconnects from the specified peer node.
/// Strictly one out of 'address' and 'nodeid' can be provided to identify the node.
/// To disconnect by nodeid, either set 'address' to the empty string, or call using the named 'nodeid' argument only.
#[macro_export]
macro_rules! impl_client_v26__disconnectnode {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getaddednodeinfo` for version v26
///
/// Returns information about the given added node, or all added nodes
/// (note that onetry addnodes are not listed here)
#[macro_export]
macro_rules! impl_client_v26__getaddednodeinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getaddrmaninfo` for version v26
///
/// Provides information about the node's address manager by returning the number of addresses in the `new` and `tried` tables and their sum for all networks.
#[macro_export]
macro_rules! impl_client_v26__getaddrmaninfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getconnectioncount` for version v26
///
/// Returns the number of connections to other nodes.
#[macro_export]
macro_rules! impl_client_v26__getconnectioncount {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getnettotals` for version v26
///
/// Returns information about network traffic, including bytes in, bytes out,
/// and current system time.
#[macro_export]
macro_rules! impl_client_v26__getnettotals {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getnetworkinfo` for version v26
///
/// Returns an object containing various state info regarding P2P networking.
#[macro_export]
macro_rules! impl_client_v26__getnetworkinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getnodeaddresses` for version v26
///
/// Return known addresses, after filtering for quality and recency.
/// These can potentially be used to find new peers in the network.
/// The total number of addresses known to the node may be higher.
#[macro_export]
macro_rules! impl_client_v26__getnodeaddresses {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getpeerinfo` for version v26
///
/// Returns data about each connected network peer as a json array of objects.
#[macro_export]
macro_rules! impl_client_v26__getpeerinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listbanned` for version v26
///
/// List all manually banned IPs/Subnets.
#[macro_export]
macro_rules! impl_client_v26__listbanned {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `ping` for version v26
///
/// Requests that a ping be sent to all other nodes, to measure ping time.
/// Results provided in getpeerinfo, pingtime and pingwait fields are decimal seconds.
/// Ping command is handled in queue with all other commands, so it measures processing backlog, not just network ping.
#[macro_export]
macro_rules! impl_client_v26__ping {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setban` for version v26
///
/// Attempts to add or remove an IP/Subnet from the banned list.
#[macro_export]
macro_rules! impl_client_v26__setban {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setnetworkactive` for version v26
///
/// Disable/enable all p2p network activity.
#[macro_export]
macro_rules! impl_client_v26__setnetworkactive {
    () => {
        impl Client {
