/// Implements Bitcoin Core JSON-RPC API method `analyzepsbt` for version v17
///
/// Analyzes and provides information about the current status of a PSBT and its inputs
#[macro_export]
macro_rules! impl_client_v17__analyzepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `combinepsbt` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `combinerawtransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `converttopsbt` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `createpsbt` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `createrawtransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `decodepsbt` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `decoderawtransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `decodescript` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `descriptorprocesspsbt` for version v17
///
/// Update all segwit inputs in a PSBT with information from output descriptors, the UTXO set or the mempool.
/// Then, sign the inputs we are able to with information from the output descriptors.
#[macro_export]
macro_rules! impl_client_v17__descriptorprocesspsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `finalizepsbt` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `fundrawtransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getrawtransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `joinpsbts` for version v17
///
/// Joins multiple distinct PSBTs with different inputs and outputs into one PSBT with inputs and outputs from all of the PSBTs
/// No input in any of the PSBTs can be in more than one of the PSBTs.
#[macro_export]
macro_rules! impl_client_v17__joinpsbts {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendrawtransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `signrawtransactionwithkey` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `submitpackage` for version v17
///
...
#[macro_export]
macro_rules! impl_client_v17__submitpackage {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `testmempoolaccept` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `utxoupdatepsbt` for version v17
///
/// Updates all segwit inputs and outputs in a PSBT with data from output descriptors, the UTXO set, txindex, or the mempool.
#[macro_export]
macro_rules! impl_client_v17__utxoupdatepsbt {
    () => {
        impl Client {
