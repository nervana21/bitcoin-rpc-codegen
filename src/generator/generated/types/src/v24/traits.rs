...
impl BlockchainResponse for v24 {
...
impl SignerResponse for v24 {
    type EnumeratesignersResponse = EnumeratesignersResponse;
}

impl RawtransactionsResponse for v24 {
