...
impl BlockchainResponse for v18 {
...
impl RawtransactionsResponse for v18 {
...
impl SignerResponse for v18 {
    type EnumeratesignersResponse = EnumeratesignersResponse;
}

impl MiningResponse for v18 {
