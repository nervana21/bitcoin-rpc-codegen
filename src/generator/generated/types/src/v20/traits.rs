...
impl BlockchainResponse for v20 {
...
impl RawtransactionsResponse for v20 {
...
impl SignerResponse for v20 {
    type EnumeratesignersResponse = EnumeratesignersResponse;
}

impl MiningResponse for v20 {
