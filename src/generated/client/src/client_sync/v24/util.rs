/// Implements Bitcoin Core JSON-RPC API method `createmultisig` for version v24
///
/// Creates a multi-signature address with n signature of m keys required.
/// It returns a json object with the address and redeemScript.
#[macro_export]
macro_rules! impl_client_v24__createmultisig {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `deriveaddresses` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__deriveaddresses {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `estimatesmartfee` for version v24
///
...
#[macro_export]
macro_rules! impl_client_v24__estimatesmartfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getdescriptorinfo` for version v24
///
/// Analyses a descriptor.
#[macro_export]
macro_rules! impl_client_v24__getdescriptorinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getindexinfo` for version v24
///
/// Returns the status of one or all available indices currently running in the node.
#[macro_export]
macro_rules! impl_client_v24__getindexinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signmessagewithprivkey` for version v24
///
/// Sign a message with the private key of an address
#[macro_export]
macro_rules! impl_client_v24__signmessagewithprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `validateaddress` for version v24
///
/// Return information about the given bitcoin address.
#[macro_export]
macro_rules! impl_client_v24__validateaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `verifymessage` for version v24
///
/// Verify a signed message.
#[macro_export]
macro_rules! impl_client_v24__verifymessage {
    () => {
        impl Client {
