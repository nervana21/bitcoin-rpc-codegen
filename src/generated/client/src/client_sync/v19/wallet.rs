/// Implements Bitcoin Core JSON-RPC API method `abandontransaction` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__abandontransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `abortrescan` for version v19
///
/// Stops current wallet rescan triggered by an RPC call, e.g. by an importprivkey call.
/// Note: Use "getwalletinfo" to query the scanning progress.
#[macro_export]
macro_rules! impl_client_v19__abortrescan {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `addmultisigaddress` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__addmultisigaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `backupwallet` for version v19
///
/// Safely copies the current wallet file to the specified destination, which can either be a directory or a path with a filename.
#[macro_export]
macro_rules! impl_client_v19__backupwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `bumpfee` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__bumpfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createwallet` for version v19
///
/// Creates and loads a new wallet.
#[macro_export]
macro_rules! impl_client_v19__createwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createwalletdescriptor` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__createwalletdescriptor {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `dumpprivkey` for version v19
///
/// Reveals the private key corresponding to 'address'.
/// Then the importprivkey can be used with this output
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v19__dumpprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `dumpwallet` for version v19
///
...
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v19__dumpwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `encryptwallet` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__encryptwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getaddressesbylabel` for version v19
///
/// Returns the list of addresses assigned the specified label.
#[macro_export]
macro_rules! impl_client_v19__getaddressesbylabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getaddressinfo` for version v19
///
/// Return information about the given bitcoin address.
/// Some of the information will only be present if the address is in the active wallet.
#[macro_export]
macro_rules! impl_client_v19__getaddressinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getbalance` for version v19
///
...
/// Implements Bitcoin Core JSON-RPC API method `getbalances` for version v19
///
...
/// Implements Bitcoin Core JSON-RPC API method `gethdkeys` for version v19
///
/// List all BIP 32 HD keys in the wallet and which descriptors use them.
#[macro_export]
macro_rules! impl_client_v19__gethdkeys {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getnewaddress` for version v19
///
/// Returns a new Bitcoin address for receiving payments.
/// If 'label' is specified, it is added to the address book
/// so payments received with the address will be associated with 'label'.
#[macro_export]
macro_rules! impl_client_v19__getnewaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawchangeaddress` for version v19
///
/// Returns a new Bitcoin address, for receiving change.
/// This is for use with raw transactions, NOT normal use.
#[macro_export]
macro_rules! impl_client_v19__getrawchangeaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getreceivedbyaddress` for version v19
///
/// Returns the total amount received by the given address in transactions with at least minconf confirmations.
#[macro_export]
macro_rules! impl_client_v19__getreceivedbyaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getreceivedbylabel` for version v19
///
/// Returns the total amount received by addresses with <label> in transactions with at least [minconf] confirmations.
#[macro_export]
macro_rules! impl_client_v19__getreceivedbylabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `gettransaction` for version v19
///
/// Get detailed information about in-wallet transaction <txid>
#[macro_export]
macro_rules! impl_client_v19__gettransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getunconfirmedbalance` for version v19
///
/// DEPRECATED
/// Identical to getbalances().mine.untrusted_pending
#[macro_export]
macro_rules! impl_client_v19__getunconfirmedbalance {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getwalletinfo` for version v19
///
/// Returns an object containing various wallet state info.
#[macro_export]
macro_rules! impl_client_v19__getwalletinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importaddress` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__importaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importdescriptors` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__importdescriptors {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importmulti` for version v19
///
...
/// Note: This command is only compatible with legacy wallets. Use "importdescriptors" for descriptor wallets.
#[macro_export]
macro_rules! impl_client_v19__importmulti {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importprivkey` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__importprivkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importprunedfunds` for version v19
///
/// Imports funds without rescan. Corresponding address or script must previously be included in wallet. Aimed towards pruned wallets. The end-user is responsible to import additional transactions that subsequently spend the imported outputs or rescan after the point in the blockchain the transaction is included.
#[macro_export]
macro_rules! impl_client_v19__importprunedfunds {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importpubkey` for version v19
///
...
/// Note: This command is only compatible with legacy wallets. Use "importdescriptors" with "combo(X)" for descriptor wallets.
#[macro_export]
macro_rules! impl_client_v19__importpubkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `importwallet` for version v19
///
/// Imports keys from a wallet dump file (see dumpwallet). Requires a new wallet backup to include imported keys.
/// Note: Blockchain and Mempool will be rescanned after a successful import. Use "getwalletinfo" to query the scanning progress.
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v19__importwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `keypoolrefill` for version v19
///
/// Fills the keypool.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__keypoolrefill {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listaddressgroupings` for version v19
///
/// Lists groups of addresses which have had their common ownership
/// made public by common use as inputs or as the resulting change
/// in past transactions
#[macro_export]
macro_rules! impl_client_v19__listaddressgroupings {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listdescriptors` for version v19
///
/// List descriptors imported into a descriptor-enabled wallet.
#[macro_export]
macro_rules! impl_client_v19__listdescriptors {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listlabels` for version v19
///
/// Returns the list of all labels, or labels that are assigned to addresses with a specific purpose.
#[macro_export]
macro_rules! impl_client_v19__listlabels {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listlockunspent` for version v19
///
/// Returns list of temporarily unspendable outputs.
/// See the lockunspent call to lock and unlock transactions for spending.
#[macro_export]
macro_rules! impl_client_v19__listlockunspent {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listreceivedbyaddress` for version v19
///
/// List balances by receiving address.
#[macro_export]
macro_rules! impl_client_v19__listreceivedbyaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listreceivedbylabel` for version v19
///
/// List received transactions by label.
#[macro_export]
macro_rules! impl_client_v19__listreceivedbylabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listsinceblock` for version v19
///
/// Get all transactions in blocks since block [blockhash], or all transactions if omitted.
/// If "blockhash" is no longer a part of the main chain, transactions from the fork point onward are included.
/// Additionally, if include_removed is set, transactions affecting the wallet which were removed are returned in the "removed" array.
#[macro_export]
macro_rules! impl_client_v19__listsinceblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listtransactions` for version v19
///
/// If a label name is provided, this will return only incoming transactions paying to addresses with the specified label.
/// Returns up to 'count' most recent transactions skipping the first 'from' transactions.
#[macro_export]
macro_rules! impl_client_v19__listtransactions {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listunspent` for version v19
///
/// Returns array of unspent transaction outputs
/// with between minconf and maxconf (inclusive) confirmations.
/// Optionally filter to only include txouts paid to specified addresses.
#[macro_export]
macro_rules! impl_client_v19__listunspent {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listwalletdir` for version v19
///
/// Returns a list of wallets in the wallet directory.
#[macro_export]
macro_rules! impl_client_v19__listwalletdir {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `listwallets` for version v19
///
/// Returns a list of currently loaded wallets.
/// For full information on the wallet, use "getwalletinfo"
#[macro_export]
macro_rules! impl_client_v19__listwallets {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `loadwallet` for version v19
///
/// Loads a wallet from a wallet file or directory.
/// Note that all wallet command-line options used when starting bitcoind will be
/// applied to the new wallet.
#[macro_export]
macro_rules! impl_client_v19__loadwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `lockunspent` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__lockunspent {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `migratewallet` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__migratewallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `newkeypool` for version v19
///
...
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__newkeypool {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `psbtbumpfee` for version v19
///
/// Bumps the fee of an opt-in-RBF transaction T, replacing it with a new transaction B.
...
/// * WARNING: before version 0.21, fee_rate was in BTC/kvB. As of 0.21, fee_rate is in sat/vB. *
#[macro_export]
macro_rules! impl_client_v19__psbtbumpfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `removeprunedfunds` for version v19
///
/// Deletes the specified transaction from the wallet. Meant for use with pruned wallets and as a companion to importprunedfunds. This will affect wallet balances.
#[macro_export]
macro_rules! impl_client_v19__removeprunedfunds {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `rescanblockchain` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__rescanblockchain {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `restorewallet` for version v19
///
/// Restores and loads a wallet from backup.
/// The rescan is significantly faster if a descriptor wallet is restored
/// and block filters are available (using startup option "-blockfilterindex=1").
#[macro_export]
macro_rules! impl_client_v19__restorewallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `send` for version v19
///
/// EXPERIMENTAL warning: this call may be changed in future releases.
/// Send a transaction.
#[macro_export]
macro_rules! impl_client_v19__send {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendall` for version v19
///
/// EXPERIMENTAL warning: this call may be changed in future releases.
...
#[macro_export]
macro_rules! impl_client_v19__sendall {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendmany` for version v19
///
/// Send multiple times. Amounts are double-precision floating point numbers.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__sendmany {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendtoaddress` for version v19
///
/// Send an amount to a given address.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__sendtoaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sethdseed` for version v19
///
...
/// Note: This command is only compatible with legacy wallets.
#[macro_export]
macro_rules! impl_client_v19__sethdseed {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setlabel` for version v19
///
/// Sets the label associated with the given address.
#[macro_export]
macro_rules! impl_client_v19__setlabel {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `settxfee` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__settxfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setwalletflag` for version v19
///
...
/// Implements Bitcoin Core JSON-RPC API method `signmessage` for version v19
///
/// Sign a message with the private key of an address
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__signmessage {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signrawtransactionwithwallet` for version v19
///
...
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__signrawtransactionwithwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `simulaterawtransaction` for version v19
///
/// Calculate the balance change resulting in the signing and broadcasting of the given transaction(s).
#[macro_export]
macro_rules! impl_client_v19__simulaterawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `unloadwallet` for version v19
///
/// Unloads the wallet referenced by the request endpoint, otherwise unloads the wallet specified in the argument.
/// Specifying the wallet name on a wallet endpoint is invalid.
#[macro_export]
macro_rules! impl_client_v19__unloadwallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `upgradewallet` for version v19
///
/// Upgrade the wallet. Upgrades to the latest version if no version number is specified.
/// New keys may be generated and a new wallet backup will need to be made.
#[macro_export]
macro_rules! impl_client_v19__upgradewallet {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletcreatefundedpsbt` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__walletcreatefundedpsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletdisplayaddress` for version v19
///
/// Display address on an external signer for verification.
#[macro_export]
macro_rules! impl_client_v19__walletdisplayaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletlock` for version v19
///
/// Removes the wallet encryption key from memory, locking the wallet.
/// After calling this method, you will need to call walletpassphrase again
/// before being able to call any methods which require the wallet to be unlocked.
#[macro_export]
macro_rules! impl_client_v19__walletlock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletpassphrase` for version v19
///
...
#[macro_export]
macro_rules! impl_client_v19__walletpassphrase {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletpassphrasechange` for version v19
///
/// Changes the wallet passphrase from 'oldpassphrase' to 'newpassphrase'.
#[macro_export]
macro_rules! impl_client_v19__walletpassphrasechange {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `walletprocesspsbt` for version v19
///
/// Update a PSBT with input information from our wallet and then sign inputs
/// that we can sign for.
/// Requires wallet passphrase to be set with walletpassphrase call if wallet is encrypted.
#[macro_export]
macro_rules! impl_client_v19__walletprocesspsbt {
    () => {
        impl Client {
