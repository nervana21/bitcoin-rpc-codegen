/// Implements Bitcoin Core JSON-RPC API method `api` for version v25
///
/// Return JSON description of RPC API.
#[macro_export]
macro_rules! impl_client_v25__api {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmemoryinfo` for version v25
///
/// Returns an object containing information about memory usage.
#[macro_export]
macro_rules! impl_client_v25__getmemoryinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrpcinfo` for version v25
///
/// Returns details of the RPC server.
#[macro_export]
macro_rules! impl_client_v25__getrpcinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `help` for version v25
///
/// List all commands, or get help for a specified command.
#[macro_export]
macro_rules! impl_client_v25__help {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `logging` for version v25
///
...
#[macro_export]
macro_rules! impl_client_v25__logging {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `stop` for version v25
///
/// Request a graceful shutdown of Bitcoin Core.
#[macro_export]
macro_rules! impl_client_v25__stop {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `uptime` for version v25
///
/// Returns the total uptime of the server.
#[macro_export]
macro_rules! impl_client_v25__uptime {
    () => {
        impl Client {
