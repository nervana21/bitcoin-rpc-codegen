/// Implements Bitcoin Core JSON-RPC API method `analyzepsbt` for version v18
///
...
/// Implements Bitcoin Core JSON-RPC API method `combinepsbt` for version v18
///
/// Combine multiple partially signed Bitcoin transactions into one transaction.
/// Implements the Combiner role.
#[macro_export]
macro_rules! impl_client_v18__combinepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `combinerawtransaction` for version v18
///
/// Combine multiple partially signed transactions into one transaction.
/// The combined transaction may be another partially signed transaction or a
/// fully signed transaction.
#[macro_export]
macro_rules! impl_client_v18__combinerawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `converttopsbt` for version v18
///
/// Converts a network serialized transaction to a PSBT. This should be used only with createrawtransaction and fundrawtransaction
/// createpsbt and walletcreatefundedpsbt should be used for new applications.
#[macro_export]
macro_rules! impl_client_v18__converttopsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createpsbt` for version v18
///
/// Creates a transaction in the Partially Signed Transaction format.
/// Implements the Creator role.
#[macro_export]
macro_rules! impl_client_v18__createpsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createrawtransaction` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__createrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decodepsbt` for version v18
///
/// Return a JSON object representing the serialized, base64-encoded partially signed Bitcoin transaction.
#[macro_export]
macro_rules! impl_client_v18__decodepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decoderawtransaction` for version v18
///
/// Return a JSON object representing the serialized, hex-encoded transaction.
#[macro_export]
macro_rules! impl_client_v18__decoderawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decodescript` for version v18
///
/// Decode a hex-encoded script.
#[macro_export]
macro_rules! impl_client_v18__decodescript {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `descriptorprocesspsbt` for version v18
///
/// Update all segwit inputs in a PSBT with information from output descriptors, the UTXO set or the mempool.
/// Then, sign the inputs we are able to with information from the output descriptors.
#[macro_export]
macro_rules! impl_client_v18__descriptorprocesspsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `finalizepsbt` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__finalizepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `fundrawtransaction` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__fundrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawtransaction` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__getrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `joinpsbts` for version v18
///
...
/// Implements Bitcoin Core JSON-RPC API method `sendrawtransaction` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__sendrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signrawtransactionwithkey` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__signrawtransactionwithkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `submitpackage` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__submitpackage {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `testmempoolaccept` for version v18
///
...
#[macro_export]
macro_rules! impl_client_v18__testmempoolaccept {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `utxoupdatepsbt` for version v18
///
