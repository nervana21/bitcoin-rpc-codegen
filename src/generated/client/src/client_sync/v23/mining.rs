/// Implements Bitcoin Core JSON-RPC API method `getblocktemplate` for version v23
///
...
#[macro_export]
macro_rules! impl_client_v23__getblocktemplate {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmininginfo` for version v23
///
/// Returns a json object containing mining-related information.
#[macro_export]
macro_rules! impl_client_v23__getmininginfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getnetworkhashps` for version v23
///
/// Returns the estimated network hashes per second based on the last n blocks.
/// Pass in [blocks] to override # of blocks, -1 specifies since last difficulty change.
/// Pass in [height] to estimate the network speed at the time when a certain block was found.
#[macro_export]
macro_rules! impl_client_v23__getnetworkhashps {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getprioritisedtransactions` for version v23
///
/// Returns a map of all user-created (see prioritisetransaction) fee deltas by txid, and whether the tx is present in mempool.
#[macro_export]
macro_rules! impl_client_v23__getprioritisedtransactions {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `prioritisetransaction` for version v23
///
/// Accepts the transaction into mined blocks at a higher (or lower) priority
#[macro_export]
macro_rules! impl_client_v23__prioritisetransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `submitblock` for version v23
///
/// Attempts to submit new block to network.
/// See https://en.bitcoin.it/wiki/BIP_0022 for full specification.
#[macro_export]
macro_rules! impl_client_v23__submitblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `submitheader` for version v23
///
/// Decode the given hexdata as a header and submit it as a candidate chain tip if valid.
/// Throws when the header is invalid.
#[macro_export]
macro_rules! impl_client_v23__submitheader {
    () => {
        impl Client {
