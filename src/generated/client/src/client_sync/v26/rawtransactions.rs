/// Implements Bitcoin Core JSON-RPC API method `analyzepsbt` for version v26
///
/// Analyzes and provides information about the current status of a PSBT and its inputs
#[macro_export]
macro_rules! impl_client_v26__analyzepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `combinepsbt` for version v26
///
/// Combine multiple partially signed Bitcoin transactions into one transaction.
/// Implements the Combiner role.
#[macro_export]
macro_rules! impl_client_v26__combinepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `combinerawtransaction` for version v26
///
/// Combine multiple partially signed transactions into one transaction.
/// The combined transaction may be another partially signed transaction or a
/// fully signed transaction.
#[macro_export]
macro_rules! impl_client_v26__combinerawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `converttopsbt` for version v26
///
/// Converts a network serialized transaction to a PSBT. This should be used only with createrawtransaction and fundrawtransaction
/// createpsbt and walletcreatefundedpsbt should be used for new applications.
#[macro_export]
macro_rules! impl_client_v26__converttopsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createpsbt` for version v26
///
/// Creates a transaction in the Partially Signed Transaction format.
/// Implements the Creator role.
#[macro_export]
macro_rules! impl_client_v26__createpsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `createrawtransaction` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__createrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decodepsbt` for version v26
///
/// Return a JSON object representing the serialized, base64-encoded partially signed Bitcoin transaction.
#[macro_export]
macro_rules! impl_client_v26__decodepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decoderawtransaction` for version v26
///
/// Return a JSON object representing the serialized, hex-encoded transaction.
#[macro_export]
macro_rules! impl_client_v26__decoderawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `decodescript` for version v26
///
/// Decode a hex-encoded script.
#[macro_export]
macro_rules! impl_client_v26__decodescript {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `descriptorprocesspsbt` for version v26
///
...
/// Implements Bitcoin Core JSON-RPC API method `finalizepsbt` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__finalizepsbt {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `fundrawtransaction` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__fundrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawtransaction` for version v26
///
...
/// Implements Bitcoin Core JSON-RPC API method `joinpsbts` for version v26
///
/// Joins multiple distinct PSBTs with different inputs and outputs into one PSBT with inputs and outputs from all of the PSBTs
/// No input in any of the PSBTs can be in more than one of the PSBTs.
#[macro_export]
macro_rules! impl_client_v26__joinpsbts {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendrawtransaction` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__sendrawtransaction {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `signrawtransactionwithkey` for version v26
///
...
#[macro_export]
macro_rules! impl_client_v26__signrawtransactionwithkey {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `submitpackage` for version v26
///
...
/// Implements Bitcoin Core JSON-RPC API method `testmempoolaccept` for version v26
///
...
/// Implements Bitcoin Core JSON-RPC API method `utxoupdatepsbt` for version v26
///
/// Updates all segwit inputs and outputs in a PSBT with data from output descriptors, the UTXO set, txindex, or the mempool.
#[macro_export]
macro_rules! impl_client_v26__utxoupdatepsbt {
    () => {
        impl Client {
