/// Implements Bitcoin Core JSON-RPC API method `api` for version v20
///
/// Return JSON description of RPC API.
#[macro_export]
macro_rules! impl_client_v20__api {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getmemoryinfo` for version v20
///
/// Returns an object containing information about memory usage.
#[macro_export]
macro_rules! impl_client_v20__getmemoryinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrpcinfo` for version v20
///
/// Returns details of the RPC server.
#[macro_export]
macro_rules! impl_client_v20__getrpcinfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `help` for version v20
///
/// List all commands, or get help for a specified command.
#[macro_export]
macro_rules! impl_client_v20__help {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `logging` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__logging {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `stop` for version v20
///
/// Request a graceful shutdown of Bitcoin Core.
#[macro_export]
macro_rules! impl_client_v20__stop {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `uptime` for version v20
///
/// Returns the total uptime of the server.
#[macro_export]
macro_rules! impl_client_v20__uptime {
    () => {
        impl Client {
