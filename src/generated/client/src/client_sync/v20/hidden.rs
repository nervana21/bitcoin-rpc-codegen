/// Implements Bitcoin Core JSON-RPC API method `addconnection` for version v20
///
/// Open an outbound connection to a specified node. This RPC is for testing only.
#[macro_export]
macro_rules! impl_client_v20__addconnection {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `addpeeraddress` for version v20
///
/// Add the address of a potential peer to an address manager table. This RPC is for testing only.
#[macro_export]
macro_rules! impl_client_v20__addpeeraddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `echo` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__echo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `echoipc` for version v20
///
/// Echo back the input argument, passing it through a spawned process in a multiprocess build.
/// This command is for testing.
#[macro_export]
macro_rules! impl_client_v20__echoipc {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `echojson` for version v20
///
/// Simply echo back the input arguments. This command is for testing.
/// It will return an internal bug report when arg9='trigger_internal_bug' is passed.
/// The difference between echo and echojson is that echojson has argument conversion enabled in the client-side table in bitcoin-cli and the GUI. There is no server-side difference.
#[macro_export]
macro_rules! impl_client_v20__echojson {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `estimaterawfee` for version v20
///
...
#[macro_export]
macro_rules! impl_client_v20__estimaterawfee {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `generate` for version v20
///
/// has been replaced by the -generate cli option. Refer to -help for more information.
#[macro_export]
macro_rules! impl_client_v20__generate {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `generateblock` for version v20
///
/// Mine a set of ordered transactions to a specified address or descriptor and return the block hash.
#[macro_export]
macro_rules! impl_client_v20__generateblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `generatetoaddress` for version v20
///
/// Mine to a specified address and return the block hashes.
#[macro_export]
macro_rules! impl_client_v20__generatetoaddress {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `generatetodescriptor` for version v20
///
...
/// Implements Bitcoin Core JSON-RPC API method `getorphantxs` for version v20
///
/// Shows transactions in the tx orphanage.
/// EXPERIMENTAL warning: this call may be changed in future releases.
#[macro_export]
macro_rules! impl_client_v20__getorphantxs {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getrawaddrman` for version v20
///
/// EXPERIMENTAL warning: this call may be changed in future releases.
/// Returns information on all address manager entries for the new and tried tables.
#[macro_export]
macro_rules! impl_client_v20__getrawaddrman {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `invalidateblock` for version v20
///
/// Permanently marks a block as invalid, as if it violated a consensus rule.
#[macro_export]
macro_rules! impl_client_v20__invalidateblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `mockscheduler` for version v20
///
/// Bump the scheduler into the future (-regtest only)
#[macro_export]
macro_rules! impl_client_v20__mockscheduler {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `reconsiderblock` for version v20
///
/// Removes invalidity status of a block, its ancestors and its descendants, reconsider them for activation.
/// This can be used to undo the effects of invalidateblock.
#[macro_export]
macro_rules! impl_client_v20__reconsiderblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `sendmsgtopeer` for version v20
///
/// Send a p2p message to a peer specified by id.
/// The message type and body must be provided, the message header will be generated.
/// This RPC is for testing only.
#[macro_export]
macro_rules! impl_client_v20__sendmsgtopeer {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `setmocktime` for version v20
///
/// Set the local time to given timestamp (-regtest only)
#[macro_export]
macro_rules! impl_client_v20__setmocktime {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `syncwithvalidationinterfacequeue` for version v20
///
/// Waits for the validation interface queue to catch up on everything that was there when we entered this function.
#[macro_export]
macro_rules! impl_client_v20__syncwithvalidationinterfacequeue {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `waitforblock` for version v20
///
/// Waits for a specific new block and returns useful info about it.
/// Returns the current block on timeout or exit.
/// Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
#[macro_export]
macro_rules! impl_client_v20__waitforblock {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `waitforblockheight` for version v20
///
...
/// Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
#[macro_export]
macro_rules! impl_client_v20__waitforblockheight {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `waitfornewblock` for version v20
///
/// Waits for any new block and returns useful info about it.
/// Returns the current block on timeout or exit.
/// Make sure to use no RPC timeout (bitcoin-cli -rpcclienttimeout=0)
#[macro_export]
macro_rules! impl_client_v20__waitfornewblock {
    () => {
        impl Client {
