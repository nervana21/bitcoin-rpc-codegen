/// Implements Bitcoin Core JSON-RPC API method `addnode` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `clearbanned` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `disconnectnode` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getaddednodeinfo` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getaddrmaninfo` for version v17
///
/// Provides information about the node's address manager by returning the number of addresses in the `new` and `tried` tables and their sum for all networks.
#[macro_export]
macro_rules! impl_client_v17__getaddrmaninfo {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getconnectioncount` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getnettotals` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getnetworkinfo` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getnodeaddresses` for version v17
///
/// Return known addresses, after filtering for quality and recency.
/// These can potentially be used to find new peers in the network.
/// The total number of addresses known to the node may be higher.
#[macro_export]
macro_rules! impl_client_v17__getnodeaddresses {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `getpeerinfo` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `listbanned` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `ping` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `setban` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `setnetworkactive` for version v17
///
