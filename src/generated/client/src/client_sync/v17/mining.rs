/// Implements Bitcoin Core JSON-RPC API method `getblocktemplate` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getmininginfo` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getnetworkhashps` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `getprioritisedtransactions` for version v17
///
/// Returns a map of all user-created (see prioritisetransaction) fee deltas by txid, and whether the tx is present in mempool.
#[macro_export]
macro_rules! impl_client_v17__getprioritisedtransactions {
    () => {
        impl Client {
...
/// Implements Bitcoin Core JSON-RPC API method `prioritisetransaction` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `submitblock` for version v17
///
...
/// Implements Bitcoin Core JSON-RPC API method `submitheader` for version v17
///
/// Decode the given hexdata as a header and submit it as a candidate chain tip if valid.
/// Throws when the header is invalid.
#[macro_export]
macro_rules! impl_client_v17__submitheader {
    () => {
        impl Client {
